...
public class ExampleQuestPackGenerator extends QuestProvider {
    ...
    protected void add(HolderLookup.Provider provider) {
        ...
        this.addQuest(new Quest.Builder(ResourceLocation.fromNamespaceAndPath("example", "multi/advancement_example_multi"),
                ...
                .addTaskEntry("trade", new AdvancementTask(DescriptiveValue.list(ResourceLocation.parse("minecraft:adventure/trade"))
                        .add(ResourceLocation.parse("minecraft:adventure/bullseye"))
                        .add(ResourceLocation.parse("minecraft:adventure/ol_betsy")).build(), true,
        ...
        this.addQuest(new Quest.Builder(ResourceLocation.fromNamespaceAndPath("example", "item_tag_example"),
        ...
        this.addQuest(new Quest.Builder(ResourceLocation.fromNamespaceAndPath("example", "multi/kill_example_multi"),
                ...
                .addTaskEntry("cows", new KillTask(List.of(
                        ...
                        DescriptiveValue.of(EntityPredicate.Builder.entity().entityType(EntityTypePredicate.of(EntityType.COW))
                                .located(LocationPredicate.Builder.inBiome(provider.lookupOrThrow(Registries.BIOME).getOrThrow(Biomes.PLAINS))).build(), "Kill %2$s plains cow")), UniformGenerator.between(5, 8), "Task: 5-8 cows or cows in a plains biome", null)));

        //Location example
        this.addQuest(new Quest.Builder(ResourceLocation.fromNamespaceAndPath("example", "submitting_predicate_example"),
                ...
                .addTaskEntry("structure", new PredicateTask(DescriptiveValue.list(EntityPredicate.Builder.entity()
                        .located(LocationPredicate.Builder.inStructure(provider.lookupOrThrow(Registries.STRUCTURE).getOrThrow(ResourceKey.create(Registries.STRUCTURE, ResourceLocation.parse("ocean_ruin_warm")))))
                ...
                .addTaskEntry("structure2", new PredicateTask(DescriptiveValue.list(EntityPredicate.Builder.entity()
                        .located(LocationPredicate.Builder.inStructure(provider.lookupOrThrow(Registries.STRUCTURE).getOrThrow(ResourceKey.create(Registries.STRUCTURE, ResourceLocation.parse("ocean_ruin_cold")))))
                        .build(), "Find a cold ocean ruin").build(), "", true)));
        this.addQuest(new Quest.Builder(ResourceLocation.fromNamespaceAndPath("example", "predicate_example"),
        ...
        this.addQuest(new Quest.Builder(ResourceLocation.fromNamespaceAndPath("example", "multi/predicate_example_multi"),
                "Example for a multi predicate quests",
                ResourceLocation.parse("chests/abandoned_mineshaft"))
                .withSortingNum(1)
                .withIcon(new ItemStack(Items.COMPASS))
                .addTaskEntry("structure", new PredicateTask(DescriptiveValue.list(EntityPredicate.Builder.entity()
                                .located(LocationPredicate.Builder.inStructure(provider.lookupOrThrow(Registries.STRUCTURE).getOrThrow(ResourceKey.create(Registries.STRUCTURE,
                                        ResourceLocation.parse("ocean_ruin_warm"))))).build(), "Go to warm ocean ruin")
                        .add(EntityPredicate.Builder.entity()
                                .located(LocationPredicate.Builder.inStructure(provider.lookupOrThrow(Registries.STRUCTURE).getOrThrow(ResourceKey.create(Registries.STRUCTURE,
                                        ResourceLocation.parse("ocean_ruin_cold"))))).build(), "Go to cold ocean ruin").build(), "Find a warm or cold ocean ruin")));
        this.addQuest(new Quest.Builder(ResourceLocation.fromNamespaceAndPath("example", "predicate_example_sneak"),
        ...
        this.addQuest(new Quest.Builder(ResourceLocation.fromNamespaceAndPath("example", "advanced/overworld_hostile"),
                ...
                .addTaskEntry("zombies_baby", new KillTask(DescriptiveValue.list(EntityPredicate.Builder.entity().entityType(EntityTypePredicate.of(EntityType.ZOMBIE))
                        .flags(EntityFlagsPredicate.Builder.flags().setIsBaby(true)).build(), "Baby Zombie").build(), ConstantValue.exactly(3), "", null))
        ...
        this.addQuest(new Quest.Builder(ResourceLocation.fromNamespaceAndPath("example", "advanced/locked_nether_hostile"),
                ...
                .addTaskEntry("fortress", new AdvancementTask(DescriptiveValue.list(ResourceLocation.parse("minecraft:nether/find_fortress")).build(), false, "", null)));
        ...
        this.addQuest(new Quest.Builder(ResourceLocation.fromNamespaceAndPath("example", "advanced/advanced_block_break"),
                ...
                .addTaskEntry("break", new BlockInteractTask(DescriptiveValue.list(BlockPredicate.Builder.block().of(Blocks.QUARTZ_STAIRS)
                        .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(HorizontalDirectionalBlock.FACING, Direction.EAST)).build(), "East Facing Quartz Block").build(),
                        DescriptiveValue.list(ItemPredicate.Builder.item().of(Items.DIAMOND_PICKAXE)
                                .withSubPredicate(ItemSubPredicates.ENCHANTMENTS, ItemEnchantmentsPredicate.enchantments(List.of(new EnchantmentPredicate(provider.lookupOrThrow(Registries.ENCHANTMENT).getOrThrow(Enchantments.UNBREAKING), MinMaxBounds.Ints.atLeast(1))))).build(), "Unbreaking 1 Diamond Pickaxe").build(), ConstantValue.exactly(3), false, false, false, "Quartz Stairs", null)));
        ...
        this.addQuest(new Quest.Builder(ResourceLocation.fromNamespaceAndPath("example", "visibility/requirements"),
                ...
                .withUnlockCondition(EntityPredicate.Builder.entity().located(LocationPredicate.Builder.location().setY(MinMaxBounds.Doubles.atLeast(64))).build())
