...
public class MultiCraftingEntry extends MultiQuestEntryBase {
    ...
    public static final QuestEntryKey<MultiCraftingEntry> ID = new QuestEntryKey<>(new ResourceLocation(SimpleQuestsAPI.MODID, "multi_crafting"));
    ...
    public QuestEntry resolve(PlayerQuestData data, QuestBase base) {
        ...
        return new CraftingEntry(val.getFirst(), entity.getFirst(), QuestEntryUtil.getAmount(this.amount, ctx, data, base.id), this.taskDescription, val.getSecond(), entity.getSecond());
    }
}
