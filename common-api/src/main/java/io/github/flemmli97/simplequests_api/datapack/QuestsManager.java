                ...
                try (InputStream inputStream = resource.getInputStream()) {
                    try (BufferedReader reader = new BufferedReader(new InputStreamReader(inputStream, StandardCharsets.UTF_8))) {
                        ...
                        if (jsonElement != null) {
                            ...
                            SimpleQuestsAPI.LOGGER.error("Couldn't load data file {} from {} as it's null or empty", id, fileRes);
                        }
                    }
                }
        ...
        result.categories.forEach((res, el) -> {
            if (el.isJsonObject()) {
                ...
                if (!obj.keySet().isEmpty()) {
                    ...
                    categoryBuilder.put(res, QuestCategory.CODEC.apply(true).parse(JsonOps.INSTANCE, obj).getOrThrow(false, SimpleQuestsAPI.LOGGER::error));
                }
            }
        });
