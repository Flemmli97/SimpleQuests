...
public class FishingTask implements QuestTask<FishingTask.FishingTaskResolved> {
    ...
    public static final QuestEntryKey<FishingTask> ID = new QuestEntryKey<>(ResourceLocation.fromNamespaceAndPath(SimpleQuestsAPI.MODID, "fishing"));
    ...
    public record FishingTaskResolved(DescriptiveValue<ItemPredicate> item,
        ...
        public static final MapCodec<FishingTaskResolved> CODEC = RecordCodecBuilder.mapCodec((instance) ->
