...
public class QuestNumberProvider {
    ...
    public static void init() {
        CONTEXT_MULTIPLIER = Registry.register(BuiltInRegistries.LOOT_NUMBER_PROVIDER_TYPE, new ResourceLocation(SimpleQuestsAPI.MODID, "context_multiplier"), new LootNumberProviderType(new ContextMultiplierNumberProvider.Serializer()));
    }
