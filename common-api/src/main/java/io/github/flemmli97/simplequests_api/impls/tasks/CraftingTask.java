...
public class CraftingTask implements QuestTask<CraftingTask.CraftingTaskResolved> {
    ...
    public static final QuestEntryKey<CraftingTask> ID = new QuestEntryKey<>(new ResourceLocation(SimpleQuestsAPI.MODID, "crafting"));
    public static final Codec<CraftingTask> CODEC = RecordCodecBuilder.create((instance) ->
    ...
    public record CraftingTaskResolved(DescriptiveValue<ItemPredicate> item,
        ...
        public static final Codec<CraftingTaskResolved> CODEC = RecordCodecBuilder.create((instance) ->
