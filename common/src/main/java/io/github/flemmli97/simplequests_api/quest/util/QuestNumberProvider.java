...
public class QuestNumberProvider {
    ...
    public static void init() {
        CONTEXT_MULTIPLIER = Registry.register(Registry.LOOT_NUMBER_PROVIDER_TYPE, new ResourceLocation(SimpleQuests.MODID, "context_multiplier"), new LootNumberProviderType(new ContextMultiplierNumberProvider.Serializer()));
    }
